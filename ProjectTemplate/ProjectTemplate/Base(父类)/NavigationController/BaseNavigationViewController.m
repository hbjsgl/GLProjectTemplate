...
+ (void)initialize {
    ...
    //导航栏背景图
    [navBar setTintColor:KNavBgColor];
    [navBar setTitleTextAttributes:@{NSForegroundColorAttributeName :KNavBgFontColor, NSFontAttributeName : [UIFont systemFontOfSize:18]}];
    navBar.backgroundColor = [UIColor clearColor];
    navBar.barTintColor = [UIColor clearColor];
    
    [navBar setBackgroundImage:[UIImage imageWithColor:KNavBgColor] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
