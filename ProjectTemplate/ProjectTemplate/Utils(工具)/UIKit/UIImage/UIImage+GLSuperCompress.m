...
#import "UIImage+GLSuperCompress.h"

@implementation UIImage (GLSuperCompress)
...
+ (NSData *)gl_compressImage:(UIImage *)image toMaxLength:(NSInteger)maxLength maxWidth:(NSInteger)maxWidth{
    ...
    CGSize newSize = [self gl_scaleImage:image withLength:maxWidth];
    UIImage *newImage = [self gl_resizeImage:image withNewSize:newSize];
